...
export const MeScreen = () => {
  ...
  <div className="flex flex-col justify-center items-center py-10 md:flex-row md:justify-between md:py-16">
    ...
    <div className="flex justify-center">
      ...
      />
      <button class="bg-transparent border border-white hover:bg-blue-500 text-white font-bold py-2 px-4 transform transition duration-500 hover:scale-110">Click me!</button>
